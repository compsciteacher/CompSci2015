...
public class CardAndRegisterTest {
    ...
    public void test14() throws Throwable {
        ...
        assertTrue("add class " + klassNameK + " method public boolean " + method + "(LyyraCard card) ",
                klassK.method(k, method).returning(boolean.class).taking(BevoCard.class).isPublic());

        String v = "\nVCode that causes the failure"
                + "k = new CashRegister(); lk = new LyyraCard(10); k." + method + "(lk);";

        BevoCard lk = new BevoCard(10);

        klassK.method(k, method).returning(boolean.class).taking(BevoCard.class).withNiceError(v).invoke(lk);
    }
    ...
    public void test23() throws Throwable {
        ...
        assertTrue("add class " + klassNameK + " method public void " + method + "(LyyraCard card, double sum) ",
                klassK.method(k, method).returningVoid().taking(BevoCard.class, double.class).isPublic());
        ...
        klassK.method(k, method).returningVoid().taking(BevoCard.class, double.class).withNiceError(v).invoke(lk, 5.0);
    }
    ...
    private void lataa(Object register, Object card, double summa) {
        ...
        try {
            Method method = ReflectionUtils.requireMethod(CashRegister.class, methodNimi, BevoCard.class, double.class);
    ...
    private boolean payEconomical(Object register, Object card) {
        ...
        try {
            Method method = ReflectionUtils.requireMethod(CashRegister.class, methodNimi, BevoCard.class);
